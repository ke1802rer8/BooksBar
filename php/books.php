<?php
    ...
    function get_genre($id = FALSE){
        ...
        WHERE books.publisher_id = publishers.id_publish and books.id = genres_books.book_id and genres.id_genres = genres_books.genre_id and genres.name_genre = 'Литература'";
    ...
    function get_adventure($id = FALSE){
        ...
        $sql = "SELECT * FROM books, publishers, genres, genres_books, authors, authors_books 
        WHERE books.publisher_id = publishers.id_publish and books.id = genres_books.book_id and genres.id_genres = genres_books.genre_id and genres.name_genre = 'Приключение'";
