...
if($_GET['sort_id']){
    ...
    </div>',$post['id'],$post['title'],$post['title'],$post['img'],$post['id'],$post['title'],$post['title'],$post['price']);
    }
    exit();
}
else{
...
if(isset($_POST['activitiesArray'])){
                ...
                <div class="section--border">
                    ...
                    <div class="section--content">
                        <div class="filters">   
                            ...
                            <div class="header__cart cartt" tabindex="0">
                                ...
                                <div class="cart-content">
                                    <ul class="cart-content__list" data-simplebar>
                                        <!--<li class="cart-content__item">
                                            <article class="cart-content__product cart-product">
                                                <img src="img/Сияние_preview.jpg" alt=""  class="cart-product__img">
                                                <div class="cart-product__text">
                                                    <h3 class="cart-product__title">Save Me</h3>
                                                    <h3 class="cart-product__author">Мона Кастен</h3>
                                                    <span class="cart-product__price">450 ₽</span>
                                                </div>
                                    ...
                                    <div class="cart-content__bottom">
                                        <div class="cart-content__fullprice">
                                            <span>Итого:</span>
                                            <span class="fullprice">458 495 ₽</span>

                                        </div>
                                        <button class="button product-card__button button_product button_cart" data-graph-path="modal" data-graph-animation="fadeInUp" data-graph-speed="700"> 
                                            <span class="js__card_button_text" name="keep">Оформить заказ</span>
                                        </button>
                                    </div>
                                </div>
                            </div>  
